 ...
 */
public class AttrBoxMode extends AttrEnum<BoxMode> {
   ...
   * @param name the name
   */
  public AttrBoxMode(final String name) {
    super(name, null);
  }
   ...
   * @param def the def
   */
  public AttrBoxMode(final String name, final BoxMode def) {
    super(name, def);
    for (final BoxMode x : BoxMode.values()) {
