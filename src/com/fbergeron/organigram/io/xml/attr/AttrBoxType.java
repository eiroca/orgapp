 ...
 */
public class AttrBoxType extends AttrEnum<BoxType> {
   ...
   * @param name the name
   */
  public AttrBoxType(final String name) {
    super(name, null);
  }
   ...
   * @param def the def
   */
  public AttrBoxType(final String name, final BoxType def) {
    super(name, def);
    for (final BoxType x : BoxType.values()) {
